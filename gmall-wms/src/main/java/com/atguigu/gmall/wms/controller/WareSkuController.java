...
public class WareSkuController {
    ...
    public ResponseVo<List<SkuLockVo>> checkAndLockStock(@RequestBody List<SkuLockVo> lockVos,@PathVariable("orderToken")String orderToken){
        List<SkuLockVo> skuLockVos = wareSkuService.checkAndLockStock(lockVos,orderToken);
