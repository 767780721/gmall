...
public class SpuController {
    ...
    public ResponseVo<PageResultVo> querySpuByCidPage(
            @PathVariable("categoryId") Long cid,
            PageParamVo pageParamVo){
      PageResultVo pageResultVo = spuService.spuByCidPage(cid,pageParamVo);
    ...
    public ResponseVo update(@RequestBody SpuEntity spu){
        ...
        rabbitTemplate.convertAndSend("SPU_ITEM_EXCHANGE","item.update",spu.getId());
        return ResponseVo.ok();
    }
