...
public class OssController {
    ...
    public ResponseVo<Object> policy(){
        String accessId = "LTAI4G1tqgxNDK6F3GfUqgJG"; // 请填写您的AccessKeyId。
        String accessKey = "Fz4EWVBxja20el2VOSzBlnC5Lqu4Q4"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-shanghai.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "gmall-zm"; // 请填写您的 bucketname 。
